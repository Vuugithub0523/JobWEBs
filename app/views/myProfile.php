...
// Kiểm tra xem người dùng có thông tin trong session hay không
                ...
                <form action="<?php echo BASE_URL; ?>/myProfile/updateProfile" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="avatar-content-myProfile">
                        ...
                        <div class="middle-avatar-content-myProfile">
                            <img src="<?php echo $user['avatar']; ?>" alt="avatar_account">
                        </div>

                        <div class="right-avatar-content-myProfile">
    <p>
        <span style="color: blue; font-weight: bold" id="change-avatar">Nhấn để thay thế</span>
    </p>
                    ...
                    <div class="personal-info-content-myProfile">
                        ...
                        <div class="right-personal-info-content-myProfile">
                            <div class="form-group">
                                ...
                                <input type="text" id="fullname" name="fullname" value="<?php echo $user['full_name']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="small-form-group">
                                    ...
                                    <input type="date" id="birthday" name="birthday" value="<?php echo $user['date_of_birth']; ?>" required>
                                </div>
        ...
        document.getElementById('avatar-upload').addEventListener('change', function(event) {
            ...
            if (file) {
                ...
                reader.onload = function(e) {
                    // Cập nhật ảnh đại diện trong giao diện người dùng
                    document.querySelector('.middle-avatar-content-myProfile img').src = e.target.result;
                };
